...
from app.core.dependencies import get_current_school_admin, get_current_super_admin, get_db
from app.schemas import TeacherRegistrationRequest, TeacherCreate, TeacherListResponse
